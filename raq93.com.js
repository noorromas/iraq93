...
ul.nav.nav-tabs {
    ...
    background-image: -webkit-linear-gradient(160deg,#f9f9f9 25%,#728ea1 25%,#d4d4d4 50%,#728ea1 50%,#d4d4d4 75%,#d4d4d4 75%,#f9f9f9)!important;
    background: #ebebeb;
...
#chats{background-color:#d4cfd2!important;background-image:url(https://up6.cc/2026/06/178231970002621.jpg);background-size:100%}
}
